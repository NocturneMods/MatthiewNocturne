            ...
            if (nbPanelProcess.pNbPanelAnalyzeUnitWork != null)
            {
                ...
                switch (ID)
                {
                    ...
                    case 0317: //Troll
                        ...
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill01/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(11);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill02/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(98);
                        break;
                    case 0300: //Orthrus
                        affinitiesText = "Drn: Fire • Null: Light/Dark/Nerve/Mind • Str: Curse • Weak: Ice";
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill01/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(4);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill02/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(176);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill03/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(2);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill04/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(5);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill05/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(3);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill06/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(125);
                        break;
                    case 0301: //Yaksini
                        affinitiesText = "Null: Force/Light/Dark/Nerve/Mind • Str: Curse • Weak: Elec";
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill01/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(22);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill02/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(20);
                        ...
                        break;
                    case 0302: //Thor1
                        affinitiesText = "Rpl: Elec/Light Null: Dark/Nerve/Mind • Str: Curse";
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill01/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(16);
                    ...
                    case 0337: //Thor2
                        ...
                        break;
                    case 0307: //Eligor1
                        affinitiesText = "Null: Dark/Ailments • Str: Phys/Light • Weak: Elec";
                        ...
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill02/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(32);
                    ...
                    case 0309: //Eligor3
                        ...
                        break;
                    case 0312: //Berith
                        affinitiesText = "Drn: Fire • Null: Light/Dark/Ailments • Str: Phys • Weak: Ice";
                        ...
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill02/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(4);
                    ...
                    case 0261: //Koppa
                        ...
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill01/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(184);
                    ...
                    case 0315: //Kaiwan2
                        ...
                        break;
                    case 0263: //Ose
                        affinitiesText = "Null: Light/Dark/Ailments • Str: Curse/Mind/Nerve";
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill01/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(101);
                    ...
                    case 0292: //Noah1
                        ...
                        if (nbCalc.nbGetAisyo(71, 4, 0) == 131072)
                        {
                            ...
                            if (nbCalc.nbGetAisyo(71, 4, 1) == 131072)
                            {
                                repelText += "/Fire";
                            }

                            if (nbCalc.nbGetAisyo(71, 4, 2) == 131072)
                            {
                                repelText += "/Ice";
                            }

                            if (nbCalc.nbGetAisyo(71, 4, 3) == 131072)
                            {
                                repelText += "/Elec";
                            }

                            if (nbCalc.nbGetAisyo(71, 4, 4) == 131072)
                            {
                                repelText += "/Force";
                            }
                    ...
                    case 0349: //Matador
                        ...
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill02/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(22);
                    ...
                    case 0351: //Daisoujou
                        ...
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill02/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(31);
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill03/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(35);
                        ...
                        nbMainProcess.GetBattleUI(5).transform.Find("banalyze_skill/banalyze_skill05/banalyze_textTM").gameObject.GetComponent<TextMeshProUGUI>().text = datSkillName.Get(277);
                        break;
